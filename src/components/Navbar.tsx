...
const Navbar = () => {
  ...
  return (
    <nav className="lg:py-2 lg:px-0 py-1 px-4 relative flex items-center justify-between ">
      <Link href="/">
      ...
      <div className="z-20 text-right">
        <Menu as="div" className="relative inline-block text-left">
          <div>
            {session ? (
              <Menu.Button className="inline-flex w-full items-center justify-center rounded-md  px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                <Image
          ...
          >
            <Menu.Items className="absolute right-0 mt-2 w-40 origin-top-right divide-y divide-gray-100 rounded-md bg-primary shadow-lg shadow-secondary/25 ring-1 ring-secondary ring-opacity-10 focus:outline-none">
              <div className="p-2 ">
                <Link href="/profile">
